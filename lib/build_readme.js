...
function build_readme(entry, callback) {
    ...
    var readmes = [
	'README.metacran', 'inst/README.metacran', 'README.md',
	'README.markdown', 'README.mdown', 'README.mkdn', 'inst/README.md',
	'inst/README.markdown', 'inst/README.mdown', 'inst/README.mkdn'
    ];
...
function do_markdown(package, md, callback) {
    ...
    var html = marky(filter_md(md), { package: pkg });
    callback(null, html);
}
